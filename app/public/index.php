<?php
$errors = [];
if (isset($_POST["email"],$_POST["pass"], $_POST["firstName"], $_POST["lastName"], $_POST["phoneNumber"])) {

    $connect = new PDO("pgsql:host=db;dbname=dbname", "dbuser", "dbpwd");

    function validateFirstName(string $firstName, array $err): array {
    ...
    function validateLastName(string $lastName, array $err): array {
    ...
    function validatePassword(string $pass, array $err): array{
    ...
    function validateEmail(string $email, PDO $connect, array $err): array {
        if (empty($email)) {
    ...
    function validate(array $data, PDO $connect): array {
        ...
        $errors += validateFirstName($firstName, $errors);
        $errors += validateLastName($lastName, $errors);
        $errors += validatePassword($pass, $errors);
        $errors += validateEmail($email, $connect, $errors);
...
VALUES(:firstname,:lastname,:email,:cellphone,:password)");
        $sth->execute(['firstname' => $_POST['firstName'],
